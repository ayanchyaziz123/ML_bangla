        ...
        <main className="flex-1 min-w-0">
          ...
          <div
            className="prose prose-sm sm:prose-base max-w-none
              ...
              prose-h3:text-xl prose-h3:mt-10 prose-h3:mb-3 prose-h3:border-b prose-h3:border-gray-100 prose-h3:pb-2
              ...
              prose-pre:bg-gray-950 prose-pre:text-gray-200 prose-pre:rounded-xl prose-pre:text-sm prose-pre:leading-relaxed
              prose-table:text-sm prose-th:border prose-th:border-gray-200 prose-th:bg-gray-50 prose-th:px-3 prose-th:py-2 prose-th:text-left prose-th:font-semibold prose-td:border prose-td:border-gray-200 prose-td:px-3 prose-td:py-2 prose-td:text-gray-600 prose-td:align-top
          ...
          <div className="flex items-start justify-between gap-6">
            {prevBlog ? (
              <Link href={`/blog/${prevBlog.slug}`} className="group flex-1">
            ...
            {nextBlog ? (
              <Link href={`/blog/${nextBlog.slug}`} className="group flex-1 text-right">
                <div className="flex items-center justify-end gap-1 text-xs text-gray-400 mb-1">পরের পোস্ট →</div>
                <p className="text-sm font-semibold text-gray-700 group-hover:text-gray-900 transition-colors leading-snug line-clamp-2">
                  {nextBlog.title}
                </p>
              </Link>
